...
*/
/*  Copyright 2009  Submit to Any for Wordpress  (email : webmaster@jjtcomputing.co.uk)
...
{
$postfooter= get_option('customposttext_postfooter');

return $content.$postfooter;	
}
?>
...
<input type="hidden" name="page_options" value="customposttext_postfooter" />
<p class="submit">
